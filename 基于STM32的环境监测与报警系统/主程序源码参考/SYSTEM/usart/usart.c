...
*	返回参数：	无
*
*	说明：		TX-PA3		RX-PA2 用于和esp8266进行通信
************************************************************
*/
...
*	返回参数：	无
*
*	说明：		TX-PB10		RX-PB11 用于和esp8266进行通信
************************************************************
*/
...
void HMISendb(u8 k)		         //字节发送函数  连续发送三个0xFF
{		 
	u8 i;
	 for(i=0;i<3;i++)
	 {
